...
// Open mode
//
#define MODE_READONLY	0x00	// open for read only access
#define MODE_WRITEONLY	0x01	// open for write only access
#define MODE_READWRITE	0x02	// open for read/write access
